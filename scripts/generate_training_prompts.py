...
OUTPUT_FILE = "/home/jeremie/Documents/Developpement/ghostarr/training_prompts_import.json"

SYSTEM_PROMPT = "Tu es Ghostarr, un assistant IA pour homelab. Tu aides l'utilisateur à gérer ses services média et infrastructure."
