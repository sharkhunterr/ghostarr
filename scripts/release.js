#!/usr/bin/env node
/**
 * Flexible release script for Ghostarr
 *
 * Features:
...
// Main release flow
async function main() {
  console.log('🚀 Ghostarr Release Script\n');
  ...
  if (!options.skipRelease) {
    ...
    const releaseNotesFile = '/tmp/ghostarr-release-notes.md';
    ...
    if (options.github) {
      ...
      const githubRepo = process.env.GITHUB_REPO || 'sharkhunterr/ghostarr';
